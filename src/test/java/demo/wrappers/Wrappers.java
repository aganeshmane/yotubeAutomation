...
public class Wrappers {
    ...
    public void topThreeNews(String newsType) throws InterruptedException {
        ...
        List<WebElement> likeList = driver.findElements(By.xpath("//span[text()='"+newsType +"']/ancestor::div[@id='dismissible']/div[@id='contents']/ytd-rich-item-renderer//div[@id='content']/ytd-post-renderer/div/div[@id='toolbar']/ytd-comment-action-buttons-renderer/div/span[@id='vote-count-middle']"));
        long sum = 0;
        for (int i = 0; i < 3; i++) {
        ...
        //         "//span[text()='" + newsType+ "']/following::div[@id='contents']/descendant::div[@id='body']/div[@id='post-text']/yt-formatted-string[contains(text(),'VIJAYAVANI DIGITAL')]"));
